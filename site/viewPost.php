...
echo '<div id="postLinks" style="display: flex;"> 
                           ...
                           <a href="formEditPost.php?id='   . $postId . '" title="Edit">   <img src="images/edit.png"   style="width: 20px; border-radius: 0px; padding: 2px 2px 0px 2px;" > </a> 
                           <a href="formDeletePost.php?id=' . $postId . '" title="Delete"> <img src="images/trash.png"  style="width: 17px; border-radius: 0px;" > </a></div>';
echo '<h2> ' . $post['title'] . '</h2>';
echo '<img src="load-thing-image.php?id=' . $postId . '" alt="Photo of cat" ><br>';
echo '<h4>' . $post['descript'] . '</h4>';
...
foreach ($comments as $comment) {
    ...
    echo  '<br>';
    echo  '<div id="postLinks" style="display: flex;">
           <a href="formCommentReport.php?code=' . $comment['code'] . '&id=' . $postId . '" title="Report"> <img src="images/report.png" style="width: 24px; background-color: transparent; border-radius: 0px; padding-top: 3px;" > </a>
           <a href="formCommentEdit.php?code='   . $comment['code'] . '&id=' . $postId . '" title="Edit"  > <img src="images/edit.png"   style="width: 17px; background-color: transparent; border-radius: 0px; padding: 0px 2px 2px 0px;" > </a>
